...
st.write('')
st.write('One of the exciting events was the excavation of the new Tipping Hall pit, which the general contractor - not Arcadis - ended up electing to use blasting for because of the density of rock. If you are interested, you can see a video a couple of seconds long [here](https://arcadiso365.sharepoint.com/:v:/r/teams/project-30001651/mediagallery/Blast%203-6-17%204PM.mp4?csf=1&web=1&e=jlSo40&nav=eyJyZWZlcnJhbEluZm8iOnsicmVmZXJyYWxBcHAiOiJTdHJlYW1XZWJBcHAiLCJyZWZlcnJhbFZpZXciOiJTaGFyZURpYWxvZy1MaW5rIiwicmVmZXJyYWxBcHBQbGF0Zm9ybSI6IldlYiIsInJlZmVycmFsTW9kZSI6InZpZXcifX0%3D).')
st.write('After excavating this massive pit, the general contractor poured a concrete slab roughly equivalent to a football field in one pour, which required some unusal techniques. More photos can be seen [here](https://arcadiso365.sharepoint.com/teams/project-30001651/mediagallery/Forms/Thumbnails.aspx).')
st.write('')
