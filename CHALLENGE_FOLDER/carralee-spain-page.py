...
st.write('')
st.write('One of the exciting events was the excavation of the new Tipping Hall pit, which the general contractor - not Arcadis - ended up electing to use blasting for because of the density of rock. If you are interested, you can see a video a couple of seconds long at:')
st.html('<a href="https://arcadiso365.sharepoint.com/:v:/r/teams/project-30001651/mediagallery/Blast%203-6-17%204PM.mp4?csf=1&web=1&e=jlSo40&nav=eyJyZWZlcnJhbEluZm8iOnsicmVmZXJyYWxBcHAiOiJTdHJlYW1XZWJBcHAiLCJyZWZlcnJhbFZpZXciOiJTaGFyZURpYWxvZy1MaW5rIiwicmVmZXJyYWxBcHBQbGF0Zm9ybSI6IldlYiIsInJlZmVycmFsTW9kZSI6InZpZXcifX0%3D></a>')
st.write('After excavating this massive pit, the general contractor poured a concrete slab roughly equivalent to a football field in one pour, which required some unusal techniques. More photos can be seen here:')
st.html('<a href="https://arcadiso365.sharepoint.com/teams/project-30001651/mediagallery/Forms/Thumbnails.aspx</a>')
st.write('')
st.write('The other exciting project on this site that I am proud to have been a part of began in concurrence with this one, and was the first Ash Recycling Facility of its kind in the United States.  It takes ash from the waste to energy plant incinerator and harvests all the viable aggregates, metals, and sand, reducing the ash that must be managed at a landfill.')
st.write('')
st.write('')
...
st.write('')
st.write('Here is a link to a very basic Python program that I did as an early project in my "Code in Place" course through Stanford:')
st.html('<a href="https://codeinplace.stanford.edu/cip4/share/h25pEezoWb0YAm7svm7y</a>')
